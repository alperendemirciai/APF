...
class EuclideanSimilarity(BaseSimilarity):
    """
    Class to compute Euclidean similarity between two vectors.
    """

    def compute_similarity(self, idx1: np.ndarray, idx2: np.ndarray) -> float:
        """
        Compute the Euclidean similarity between two numpy arrays.
        :param idx1: First numpy array.
        :param idx2: Second numpy array.
        :return: Euclidean similarity between idx1 and idx2.
        """
        ...
        return -np.linalg.norm(idx1 - idx2)  # Negative because smaller distance means more similarity